...
%global DASHBOARD_FILE cyb3rhq-dashboard.tar.gz
...
cp cyb3rhq-dashboard-base/config/node.options %{buildroot}%{CONFIG_DIR}
cp cyb3rhq-dashboard-base/config/opensearch_dashboards.yml %{buildroot}%{CONFIG_DIR}
...
%attr(0750, %{USER}, %{GROUP}) "/etc/default/cyb3rhq-dashboard"
