...
2. Clone the [cyb3rhq-dashboard][app-repo] and the [cyb3rhq-security-dashboards-plugin][security-repo]
...
Once the `cyb3rhq-dashboard` container is up, attach a shell to it and run `yarn start --no-base-path`
...
[app-repo]: https://github.com/cyb3rhq/cyb3rhq-dashboard
[security-repo]: https://github.com/cyb3rhq/cyb3rhq-security-dashboards-plugin
