...
export const HomeIcon = ({ branding, logos }: Props) => {
  // Removed prop unnecessary useExpandedHeader Cyb3rhq dashboards
  const { applicationTitle = 'Cyb3rhq dashboards', useExpandedHeader } = branding;
  ...
  // If no custom branded mark was set, use `home` icon Cyb3rhq dashboards
